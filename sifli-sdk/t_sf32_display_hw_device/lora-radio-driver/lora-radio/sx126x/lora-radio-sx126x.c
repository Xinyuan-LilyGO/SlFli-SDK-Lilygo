...
static rt_uint8_t rt_lora_radio_thread_stack[2048];
#endif
...
const RadioLoRaBandwidths_t Bandwidths[] = {LORA_BW_062, LORA_BW_125,
 ...
 * \brief spi initilize
 */
extern struct rt_spi_device *lora_radio_spi_init(const char *bus_name,
...
bool RadioInit(RadioEvents_t *events)
{
    ...
    LORA_RADIO_DEBUG_LOG(LR_DBG_INTERFACE, LOG_LEVEL, "SX126xIoInit\n");
                      ...
                      bool iqInverted, bool rxContinuous)
{
    ...
    case MODEM_LORA:
        ...
        // WORKAROUND - Optimizing the Inverted IQ Operation, see
        // DS_SX1261-2_V1.2 datasheet chapter 15.4
                        ...
                        bool crcOn)
{
    ...
    case MODEM_LORA:
    {
        numerator = 1000U * RadioGetLoRaTimeOnAirNumerator(
                                bandwidth, datarate, coderate, preambleLen,
...
uint8_t RadioRead(uint16_t addr)
{
    ...
    uint8_t ret = SX126xReadRegister(addr);
        ...
        if ((irqRegs & IRQ_RX_DONE) == IRQ_RX_DONE)
        {
            ...
            else
            {
                ...
                if (RxContinuous == false)
                {
                    ...
                    // DS_SX1261-2_V1.2 datasheet chapter 15.3 RegRtcControl =
                    // @address 0x0902

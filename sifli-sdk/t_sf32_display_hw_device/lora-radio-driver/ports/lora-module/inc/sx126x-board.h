...
#include "sx126x.h"
    ...
    #ifndef LORA_RADIO_ENABLE_PIN
    #define LORA_RADIO_ENABLE_PIN  rt_pin_get(LORA_RADIO_ENABLE_PIN)
    #endif
    #ifndef LORA_RADIO_NSS_PIN
    #define LORA_RADIO_NSS_PIN    rt_pin_get(LORA_RADIO_NSS_PIN)
    #endif
    #ifndef LORA_RADIO_RESET_PIN
    #define LORA_RADIO_RESET_PIN  rt_pin_get(LORA_RADIO_RESET_PIN)
    #endif
    #ifndef LORA_RADIO_DIO1_PIN
    #define LORA_RADIO_DIO1_PIN   rt_pin_get(LORA_RADIO_DIO1_PIN)
    #endif
    #ifndef LORA_RADIO_BUSY_PIN
    #define LORA_RADIO_BUSY_PIN   rt_pin_get(LORA_RADIO_BUSY_PIN)
    #endif
    // #ifdef LORA_RADIO_RFSW1_PIN
    // #define LORA_RADIO_RFSW1_PIN  rt_pin_get(LORA_RADIO_RFSW1_PIN)
    // #endif
    // #ifdef LORA_RADIO_RFSW2_PIN
    // #define LORA_RADIO_RFSW2_PIN  rt_pin_get(LORA_RADIO_RFSW2_PIN)
    // #endif
